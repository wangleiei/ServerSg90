...
/**********************************************************************************************************
*	函 数 名: void ServerSg90_Inter(SERVERSG90_DEV *base,uint16_t interupt_frequs)
...
/**********************************************************************************************************
*	函 数 名: void ServerSg90_Init(SERVERSG90_DEV *base,void(*serversg90_pwm_l)(void),void(*serversg90_pwm_h)(void))
*	功能说明: 控制接口初始化，确定控制接口，
...
/**********************************************************************************************************
*	函 数 名: void ServerSg90Control(SERVERSG90_DEV *base,float angle){
...
void ServerSg90Control(SERVERSG90_DEV *base,float angle){
	if((angle >= 0.00) && (angle <= 180.00)){
		...
		if(base->pwm_mode == PWM_MODE){
			base->serversg90_pwm((angle/18+2.5)/100);
		}else{
